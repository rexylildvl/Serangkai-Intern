<x-app-layout>
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header Section -->
            <div class="mb-8">
                <h1 class="text-2xl font-semibold text-[#3B3B1A]">Edit Logbook</h1>
                <p class="text-sm text-[#626F47] mt-1">Perbarui data logbook aktivitas harian</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <textarea name="aktivitas" id="aktivitas" rows="3" 
                                      class="w-full border-[#AEC8A4]/50 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#AEC8A4]/50 focus:border-[#AEC8A4] transition" required>{{ old('aktivitas', $logbook->aktivitas) }}</textarea>
                            @error('aktivitas')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <textarea name="kendala" id="kendala" rows="2" 
                                      class="w-full border-[#AEC8A4]/50 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#AEC8A4]/50 focus:border-[#AEC8A4] transition">{{ old('kendala', $logbook->kendala) }}</textarea>
                        </div>
                    </div>
