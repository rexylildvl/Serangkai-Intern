<x-app-layout>
    <section class="relative bg-cover bg-center bg-no-repeat min-h-screen py-10" style="background-image: url('/images/gelap.jpg')">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Form Container - Updated to match detail pendaftaran colors -->
            <div class="bg-white/90 rounded-xl shadow-sm overflow-hidden backdrop-blur-sm">
                ...
                <div class="bg-[#626F47] px-6 py-4">
                    <h2 class="text-lg font-bold text-white">Formulir Logbook</h2>
                    <p class="text-sm text-gray-300 mt-1">Isi data logbook harian Anda</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="status" id="status" 
                                ...
                                <option value="On Progress" {{ old('status') == 'On Progress' ? 'selected' : '' }} class="text-[#3B3B1A]">On Progress</option>
                                <option value="Done" {{ old('status') == 'Done' ? 'selected' : '' }} class="text-[#3B3B1A]">Done</option>
                            </select>
                            @error('status')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <textarea name="aktivitas" id="aktivitas" rows="3" 
                                      class="w-full rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#AEC8A4]/50 bg-white text-[#3B3B1A] placeholder-[#626F47]/70 border border-[#AEC8A4]/50 focus:border-[#626F47] transition" required>{{ old('aktivitas') }}</textarea>
                            @error('aktivitas')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <textarea name="kendala" id="kendala" rows="2" 
                                      class="w-full rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#AEC8A4]/50 bg-white text-[#3B3B1A] placeholder-[#626F47]/70 border border-[#AEC8A4]/50 focus:border-[#626F47] transition">{{ old('kendala') }}</textarea>
                        </div>
                    </div>
