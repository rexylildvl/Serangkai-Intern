...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Lowongan Magang Baru</h2>
    ...
    <form action="{{ route('admin.lowongan.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-gray-50 p-5 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Status Lowongan <span class="text-red-500">*</span></label>
        ...
        <div class="bg-gray-50 p-5 rounded-lg">
            ...
            <textarea name="deskripsi" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">{{ old('deskripsi') }}</textarea>
        </div>
