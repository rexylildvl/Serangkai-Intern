<nav x-data="{ open: false }" class="bg-gradient-to-r from-[#4B6043] to-[#73815D] shadow-lg py-4">
            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="hidden sm:flex space-x-6 ms-10 text-white text-[16px] font-medium">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                        class="transition duration-200 ease-in-out hover:underline hover:underline-offset-8 hover:decoration-white hover:text-white"
                        :class="request()->routeIs('dashboard') ? 'border-b-4 border-white pb-1' : ''">
                        {{ __('Beranda') }}
                    </x-nav-link>

                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('coe')"
                        class="transition duration-200 ease-in-out hover:underline hover:underline-offset-8 hover:decoration-white hover:text-white"
                        :class="request()->routeIs('coe') ? 'border-b-4 border-white pb-1' : ''">
                        {{ __('Center of Excellence') }}
                    </x-nav-link>

                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('berita')"
                        class="transition duration-200 ease-in-out hover:underline hover:underline-offset-8 hover:decoration-white hover:text-white"
                        :class="request()->routeIs('berita') ? 'border-b-4 border-white pb-1' : ''">
                        {{ __('Berita') }}
                    </x-nav-link>

                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('magang')"
                        class="transition duration-200 ease-in-out hover:underline hover:underline-offset-8 hover:decoration-white hover:text-white"
                        :class="request()->routeIs('magang') ? 'border-b-4 border-white pb-1' : ''">
                        {{ __('Lowongan Magang') }}
                    </x-nav-link>

                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('galeri')"
                        class="transition duration-200 ease-in-out hover:underline hover:underline-offset-8 hover:decoration-white hover:text-white"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="sm:hidden bg-[#73815D] text-white px-4 pb-6 pt-4 space-y-1">
        ...
        <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('coe')">
            {{ __('Center of Excellence') }}
        </x-responsive-nav-link>
        <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('berita')">
            {{ __('Berita') }}
        </x-responsive-nav-link>
        <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('magang')">
            {{ __('Lowongan Magang') }}
        </x-responsive-nav-link>
        <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('galeri')">
            {{ __('Galeri') }}
        </x-responsive-nav-link>
