                                ...
                                <div class="p-6 flex-grow">
                                    <ul class="space-y-3 mb-4">
                                        <li class="flex items-start">
                                            ...
                                            <div>
                                                <div class="text-xs font-medium text-[#626F47]">Divisi</div>
                                                <div class="text-sm text-[#3B3B1A]">{{ $job->divisi }}</div>
                                            </div>
                                        </li>
                                        <li class="flex items-start">
                                            <svg class="w-4 h-4 mr-2 mt-0.5 text-[#8A784E] flex-shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="space-y-4">
                    ...
                    <div x-data="{ open: false }" class="border border-[#8A784E] rounded-xl overflow-hidden bg-white/95 backdrop-blur-sm">
                        ...
                        <div x-show="open" x-collapse class="prose faq-content px-6 pb-4 text-[#626F47] bg-[#F5FBE7]">
                            {!! $faq->jawaban !!}
                        </div>
                    </div>
                    @empty
