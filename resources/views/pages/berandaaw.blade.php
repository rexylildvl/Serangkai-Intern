    ...
    <section class="bg-[#E7EFC7] py-20">
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="{{ route('berita.index') }}" class="text-[#626F47] hover:text-[#3B3B1A] font-medium flex items-center">
                    Semua Berita
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
...
<!-- Galeri -->
<section class="bg-[#E7EFC7] py-20" x-data="{
    open: false, 
    selected: null,
    init() {
        this.open = false;
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="text-center mb-12">
            <h2 class="text-4xl font-serif font-bold text-[#3B3B1A] mb-4 tracking-tight">
                Dokumentasi Kegiatan
            </h2>
            
            <div class="w-24 h-0.5 bg-[#AEC8A4] mx-auto mb-6"></div>
            
            <p class="text-[#3B3B1A] text-lg max-w-2xl mx-auto leading-relaxed font-light">
        ...
        <div class="mt-16 text-center">
            <a href="{{ route('galeri.index') }}" class="inline-flex items-center bg-[#AEC8A4] hover:bg-[#8A9E7F] text-[#3B3B1A] font-medium px-8 py-3 rounded-full text-lg shadow-sm hover:shadow-md transition-all duration-300">
                Lihat Semua Foto
            </a>
        </div>
    </div>
